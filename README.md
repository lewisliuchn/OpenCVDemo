...
A tutorial for setting up OpenCV 3.4.6 for Android in [Android Studio](https://developer.android.com/studio) with Native Development Kit (NDK) support. 
...
| Tool      | Version |
| ---       |  ---    |
| [OpenCV](https://opencv.org) | 3.4.6
| [Android Studio](https://developer.android.com/studio) | 3.5.2
| [Android Build Tool](https://developer.android.com/about) | 29.0.2
...
4. Install *OpenCV Android release* :
    * Download [OpenCV 3.4.6 Android release](https://sourceforge.net/projects/opencvlibrary/files/3.4.6/opencv-3.4.6-android-sdk.zip/download) or download latest available Android release on [OpenCV website](https://opencv.org/releases/).
...
opencvsdk=D\:/SDK/OpenCV-android-sdk
...
opencvsdk=D\:/SDK/OpenCV-android-sdk
    ...
    * Open [app/build.gradle](app/build.gradle) file and add `implementation project(path: ':opencv')` to dependencies section :
...
and add
`implementation 'com.android.support:support-annotations:28.0.0'`to 
dependencies section for @Nullable/@NonNull:
          dependencies {
              ...
...
9. Create your *MainActivity* :
    ...
    * You can copy paste MainActivity [Java](OpenCVDemo\app\src\main\java\com\llx\opencvdemo\MainActivity.java) file. Do not forget to adapt package name.
...
11. Add native code in *native-lib.cpp* :
    * You can copy paste [native-lib.cpp](app/src/main/cpp/native-lib.cpp) file. Do not forget to adapt the method name : 
    `Java_com_llx_opencvdemo_MainActivity_adaptiveThresholdFromJNI`
...
Tutorial, Template, OpenCV 3.4.6, Android, Android Studio, Native, NDK, Native Development Kit, JNI, Java Native Interface, C++, Java